...
<template>
    <div>
        <div v-if="!uploadedfileUrl" class="flex flex-col">
            ...
            <input
                v-model="name"
                class="mb-2 block w-full rounded-md border-0 py-1.5 px-5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                placeholder="name"
                type="text"
            />
            <input
            ...
            <div class="flex items-center justify-center w-full">
                ...
                >
                    ...
                    <input id="dropzone-file" class="hidden" type="file" v-on:change="handleFileChange" />
                </label>
            </div>
