...
<template class="flex flex-row">
    <Navbar />
    <main class="p-4 md:ml-64 h-full pt-10 w-full antialiased bg-gray-50 dark:bg-gray-900">
        <nav class=" mb-5 flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">track</span>
                </div>
                </li>
                ...
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{trackinfo?.title}}</span>
                </div>
                </li>
            </ol>
        </nav>
